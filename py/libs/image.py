...
@PromptServer.instance.routes.get("/shinich39/load-image-with-cmd/image")
...
@PromptServer.instance.routes.post("/shinich39/load-image-with-cmd/load_images")
...
@PromptServer.instance.routes.post("/shinich39/load-image-with-cmd/save_image")
...
@PromptServer.instance.routes.post("/shinich39/load-image-with-cmd/edit_image")
...
class LoadImageWithCMD():
  ...
  def INPUT_TYPES(cls):
    return {
      ...
      "optional": {
        "command": ("STRING", {"default": "", "multiline": True, "forceInput": True}),
      }
    }
